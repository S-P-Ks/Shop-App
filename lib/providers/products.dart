...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts() async {
    const url =
        "https://shop-app-ac0fd-default-rtdb.firebaseio.com/products.json";
    try {
  ...
  Future<void> deleteProduct(String id) {
    final uri = "https://shop-app-ac0fd-default-rtdb.firebaseio.com/$id.json";
    ...
    return http.delete(Uri.parse(uri)).then((res) {
